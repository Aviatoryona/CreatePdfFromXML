...
public class AppUtils {
    ...
    public static Bitmap findViewBitmap(int deviceWidth, int deviceHeight, View mPDFCreationView) {
     ...
     * @return
     */
    public static Bitmap findViewBitmap2(final List<PDFModel> currentPDFModels, int deviceWidth, int deviceHeight, PdfCreateAdapter pdfRootAdapter, RecyclerView mPDFCreationRV, View mPDFCreationView) {
